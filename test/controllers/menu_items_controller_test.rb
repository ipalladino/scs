...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { description: @menu_item.description, parent_item_id: @menu_item.parent_item_id, title: @menu_item.title, url: @menu_item.url }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { description: @menu_item.description, parent_item_id: @menu_item.parent_item_id, title: @menu_item.title, url: @menu_item.url }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
